...
'''def download_resources():
   ...
   # Dataset (40x.zip)
    os.system("gdown --id 19uzLovYrJ_Q0squYfPuKGRo_8m8H6rhl")

    # Example Images
    os.system("gdown --id 1eTqu23L0eJ4VNZvB95lpivYBqYT13oF4")
    os.system("gdown --id 1RqW4k9r4bfChNyG08hQXVotkIuEOEaxU")

    # YOLO Model Weights
    os.system("gdown --id 1kojPlfQqfP7JZqehnnLiuDyICIhOxcbU")'''

def download_resources():
    """Downloads only the specific dataset, images, and weights provided."""
    
    # Mapping your specific IDs to filenames
    resources = {
        "19uzLovYrJ_Q0squYfPuKGRo_8m8H6rhl": "40x.zip",
        "1eTqu23L0eJ4VNZvB95lpivYBqYT13oF4": "example_image_1.jpg",
        "1RqW4k9r4bfChNyG08hQXVotkIuEOEaxU": "example_image_2.jpg",
        "1kojPlfQqfP7JZqehnnLiuDyICIhOxcbU": "yolo_model_weights.pt"
    }

    for file_id, filename in resources.items():
        if not os.path.exists(filename):
            print(f"Downloading {filename}...")
            # Using the direct library call is more robust
